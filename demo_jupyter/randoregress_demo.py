...
harvest = r"C:\Users\steph\Documents\Python\Projects\Silas\Demo\RandomForest_HarvestTrip_Demo.csv"
...
'''
# quick and dirty assigning some rows to test data
Xfish = df.iloc[:, 1:12]
yfish = df.iloc[:, 0:1]
...
# view X training data
print(X_test)
print "Number of observations in training data: ", len(X_test)
# view y training data
print(y_train)
print "Number of observations in y training data: ", len(y_train)
# view y test data
print(y_test)
print "Number of observations in y test data: ", len(y_test)
